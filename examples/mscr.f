...
forever
	...
	if k='p' then
	    {
	#short
	    print bios " Error Message File: ";
	    m=name+2:while peekb m print bios chr peek m;:m++
	    print bios
	    print bios
		...
		{
		z=ms[m]b:m++
		if z then print bios "????? ?"
		else
		    {
		    print bios ms[m] chr 9;:m+=2
		    while ms[m]b print bios chr ms[m]b;:m++
		    print bios
		    }
		}
	    }
